...
function getNames(presArr) {
  // const presidentsNames = presArr.map((onePres) => {
  //   return onePres.name;
  // });
  // return presidentsNames;

  //oneliner version
  return presArr.map((onePres) => onePres.name);
}

// Iteration 2 | Democratic Presidents - `filter()`
function getDemocraticPresidents(presidentsArr) {
  // const filteredPresidents = presidentsArr.filter((onePres) => {
  //   if (onePres.party === "Democratic") {
  //     return true;
  //   }
  // });
  ...
  //oneliner version
  return presidentsArr.filter((onePres) => onePres.party === "Democratic");
}
...
function countYearsInOffice(presidentsArr) {
  ...
  const totalYears = presidentsArr.reduce((acc, currPres) => {
    if (currPres.leftOffice) {
      const yearsForOnePres = currPres.leftOffice - currPres.tookOffice;
      return acc + yearsForOnePres;
    } else {
      return acc;
    }
  }, 0);
...
function sortPresidentsByBirthYear(presidentsArr) {
  // presidentsArr.sort((currPres, nextPres) => {
  //   if (currPres.birthYear > nextPres.birthYear) {
  //     return 1;
  //   } else if (currPres.birthYear < nextPres.birthYear) {
  //     return -1;
  //   } else {
  //     return 0;
  //   }
